...
ALTER TABLE device_config ADD COLUMN IF NOT EXISTS fetch_html_on_sync TINYINT UNSIGNED DEFAULT 0;
ALTER TABLE device_pins ADD COLUMN IF NOT EXISTS exibir_display TINYINT(1) NOT NULL DEFAULT 0;
