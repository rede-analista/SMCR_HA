...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $fields = [
        ...
        'cloud_port'                 => (int)($_POST['cloud_port'] ?? 443),
            ...
            <div class="tab-pane fade <?= $active_tab === 'rede' ? 'show active' : '' ?>" id="tab-rede">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">0 = desabilitado. Reinicia o ESP após este tempo offline (tenta re-init do WiFi antes de reiniciar).</div>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" class="form-control" name="cloud_port"
                               value="<?= h($cfg['cloud_port'] ?? 443) ?>" min="1" max="65535">
                    </div>
                    <div class="col-md-2">
