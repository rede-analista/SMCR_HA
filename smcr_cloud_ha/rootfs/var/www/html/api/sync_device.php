    ...
    if (is_array($raw['config'])) {
        ...
        $stmt = $db->prepare("
            UPDATE device_config SET
                ...
                wifi_offline_restart_min   = COALESCE(:wifi_offline_rst, wifi_offline_restart_min),
                ...
                cloud_use_https            = COALESCE(:cloud_use_https, cloud_use_https),
        ...
        $stmt->execute([
            ...
            ':wifi_offline_rst'   => isset($c['wifi_offline_restart_min'])  ? (int)$c['wifi_offline_restart_min']  : null,
            ...
            ':cloud_use_https'  => isset($c['cloud_use_https'])             ? (int)$c['cloud_use_https']             : null,
